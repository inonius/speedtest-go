...
var settings = {
	...
	server: "", //inonius custom
	speedtest_session_uuid: "" //inonius custom
};
...
function sendTelemetry(done) {
	...
	try {
		...
		fd.append("server", settings.server);
		fd.append("speedtest_session_uuid", settings.speedtest_session_uuid);
		xhr.send(fd);
	} catch (ex) {
